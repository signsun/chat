# 添加可执行文件函数
function(chatServer_add_executable targetname srcs depends libs)
...
function(COMPILE_PROTO proto_file)
    ...
    # 将生成的文件添加到库中
    target_sources(chatServer PRIVATE ${proto_srcs} ${grpc_srcs})
    
    # 添加生成目录到头文件路径
    target_include_directories(chatServer PRIVATE ${CMAKE_CURRENT_BINARY_DIR})

    # 链接 Protobuf 库，这会自动添加正确的包含路径
    target_link_libraries(chatServer PRIVATE ${_PROTOBUF_LIBPROTOBUF})
endfunction()
