...
RedisConPool::RedisConPool(size_t poolSize, const char *host, int port, const char *pwd) : poolSize_(poolSize),
...
RedisMgr::RedisMgr()
{
    ...
    _con_pool.reset(new RedisConPool(24, host.c_str(), atoi(port.c_str()), pwd.c_str()));
}
